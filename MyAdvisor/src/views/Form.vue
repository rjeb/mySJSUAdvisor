                ...
                <v-card class="elevation-12">
                    ...
                    <v-card-text>
                        <v-form ref="form2" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name2" label="Name" v-model="name2" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                    ...
                    <v-card-text>
                        <v-form ref="form3" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name3" label="Name" v-model="name3" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                    ...
                    <v-card-text>
                        <v-form ref="form4" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name4" label="Name" v-model="name4" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                    ...
                    <v-card-text>
                        <v-form ref="form5" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name5" label="Name" v-model="name5" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                    ...
                    <v-card-text>
                        <v-form ref="form6" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name6" label="Name" v-model="name6" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                            <v-text-field name="number6" label="Number" v-model="number6" required>
                            </v-text-field>
                            </v-flex>
                          </v-layout>
                        </v-form>
                    ...
                    <v-card-text>
                        <v-form ref="form7" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name7" label="Name" v-model="name7" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                            <v-text-field name="number7" label="Number" v-model="number7" required>
                            </v-text-field>
                            </v-flex>
                          </v-layout>
                        </v-form>
                    ...
                    <v-card-text>
                        <v-form ref="form8" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name8" label="Name" v-model="name8" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                            <v-text-field name="number8" label="Number" v-model="number8" required>
                            </v-text-field>
                            </v-flex>
                          </v-layout>
                        </v-form>
                    ...
                    <v-card-text>
                        <v-form ref="form9" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name9" label="Name" v-model="name9" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                            <v-text-field name="number9" label="Number" v-model="number9" required>
                            </v-text-field>
                            </v-flex>
                          </v-layout>
                        </v-form>
                    ...
                    <v-card-text>
                        <v-form ref="form10" v-model="valid" lazy-validation>
                          <v-layout row wrap>
                            <v-flex xs6>
                            <v-text-field name="name10" label="Name" v-model="name10" required>
                            </v-text-field>
                            </v-flex>
                            <v-flex xs6>
                            <v-text-field name="number10" label="Number" v-model="number10" required>
                            </v-text-field>
                            </v-flex>
                          </v-layout>
                        </v-form>
